...
class RequestContext(context.RequestContext):
    ...
    def __init__(self, user_id, project_id, is_admin=None, read_deleted="no",
                 ...
                 periodic=False,  # Added for periodic backup
                 **kwargs):
        ...
        if 'vol_previous_status' in kwargs:
            self.vol_previous_status = kwargs['vol_previous_status']
    ...
    def set_periodic(self, periodic):
        if periodic not in (True, False):
            raise ValueError(_("periodic can only be one of 'True', "
                               "or 'False', not %r") % periodic)
        self.periodic = periodic
